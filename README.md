...
has a code analysis feature, but it requires a server on GitHub to build the project. The default GitHub build environment does not include 
Python. By removing Python from the project include and lib directives and using a NuGet package GitHub’s build environment was able to 
automatically pull down the Python libraries and include them in the build process.
